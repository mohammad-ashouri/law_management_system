        ...
        if (session('username')) {
            $menus = [
                1 => [
                    ...
                    'permission'=>"دسترسی به منوی کاتالوگ اولیه سامانه",
                    'childs' => [
                        1 => [
                            'title' => 'انواع مصوبه',
                            'link' => '/Types',
                            'permission'=>"دسترسی به منوی انواع مصوبه",
                        ...
                        2 => [
                            'title' => 'گروه بندی',
                            'link' => '/Groups',
                            'permission'=>"دسترسی به منوی گروه بندی",
                            'path1' => 'm15.448,7.931l2.104,2.139-5.293,5.207c-.481.482-1.118.724-1.756.724s-1.282-.244-1.771-.732l-2.776-2.69,2.088-2.154,2.453,2.378,4.951-4.87Zm8.552,4.069c0,6.617-5.383,12-12,12S0,18.617,0,12,5.383,0,12,0s12,5.383,12,12Zm-3,0c0-4.962-4.037-9-9-9S3,7.038,3,12s4.037,9,9,9,9-4.038,9-9Z',
                        ],
                        3 => [
                            'title' => 'موضوعات',
                            'link' => '/Topics',
                            'permission'=>"دسترسی به منوی موضوعات",
                            'path1' => 'm15.448,7.931l2.104,2.139-5.293,5.207c-.481.482-1.118.724-1.756.724s-1.282-.244-1.771-.732l-2.776-2.69,2.088-2.154,2.453,2.378,4.951-4.87Zm8.552,4.069c0,6.617-5.383,12-12,12S0,18.617,0,12,5.383,0,12,0s12,5.383,12,12Zm-3,0c0-4.962-4.037-9-9-9S3,7.038,3,12s4.037,9,9,9,9-4.038,9-9Z',
                        ],
                        4 => [
                            'title' => 'تصویب کنندگان',
                            'link' => '/Approvers',
                            'permission'=>"دسترسی به منوی تصویب کنندگان",
                            'path1' => 'm15.448,7.931l2.104,2.139-5.293,5.207c-.481.482-1.118.724-1.756.724s-1.282-.244-1.771-.732l-2.776-2.69,2.088-2.154,2.453,2.378,4.951-4.87Zm8.552,4.069c0,6.617-5.383,12-12,12S0,18.617,0,12,5.383,0,12,0s12,5.383,12,12Zm-3,0c0-4.962-4.037-9-9-9S3,7.038,3,12s4.037,9,9,9,9-4.038,9-9Z',
                        ],
                        5 => [
                            'title' => 'انواع ارتباط',
                            'link' => '/ReferTypes',
                            'permission'=>"دسترسی به منوی انواع ارتباط",
                            'path1' => 'm15.448,7.931l2.104,2.139-5.293,5.207c-.481.482-1.118.724-1.756.724s-1.282-.244-1.771-.732l-2.776-2.69,2.088-2.154,2.453,2.378,4.951-4.87Zm8.552,4.069c0,6.617-5.383,12-12,12S0,18.617,0,12,5.383,0,12,0s12,5.383,12,12Zm-3,0c0-4.962-4.037-9-9-9S3,7.038,3,12s4.037,9,9,9,9-4.038,9-9Z',
                        ],
                        6 => [
                ...
                2 => [
                    'title' => 'قوانین و مصوبات',
                    'link' => '/Laws',
                    'permission'=>"دسترسی به منوی قوانین و مصوبات",
