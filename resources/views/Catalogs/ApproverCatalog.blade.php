    ...
    <main class="flex-1 bg-gray-100 py-6 px-8">
        <div class="mx-auto lg:mr-72">
            ...
            <div class="bg-white rounded shadow p-6 flex flex-col ">
                @can('ایجاد تصویب کننده')
                    ...
                    <form id="new-approver">
                        ...
                        <div class="mb-4 flex items-center">
                            <div class="fixed z-10 inset-0 overflow-y-auto hidden" id="newApproverModal">
                                <div
                ...
                @endcan
                @can('ویرایش تصویب کننده')
                    <form id="edit-approver">
                        @csrf
                        <div class="mb-4 flex items-center">
                            <div class="fixed z-10 inset-0 overflow-y-auto hidden" id="editApproverModal">
                                <div
                                    class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center  sm:block sm:p-0">
                                    <div class="fixed inset-0 transition-opacity" aria-hidden="true">
                                    ...
                                    <div
                                        ...
                                        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                            ...
                                            <button id="cancel-edit-approver" type="button"
                                                    class="mt-3 w-full inline-flex justify-center px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring focus:border-blue-300 sm:mt-0 sm:w-auto">
                                                انصراف
                                            </button>
                                        </div>
                ...
                <table class="w-full border-collapse rounded-lg overflow-hidden text-center datasheet">
                    ...
                    @foreach ($approverList as $approver)
                        <tr class="bg-white">
                            ...
                            <td class="px-6 py-4">
                                @can('ویرایش تصویب کننده')
                                    <button type="submit" data-id="{{ $approver->id }}"
                                            class="px-4 py-2 mr-3 bg-blue-500 text-white rounded-md hover:bg-blue-600 focus:outline-none focus:ring focus:border-blue-300 ApproverControl">
                                        جزئیات و ویرایش
                                    </button>
                                @endcan
                                @can('تغییر وضعیت تصویب کننده')
                                    <button type="submit" data-id="{{ $approver->id }}"
                                            class="px-4 py-2 mr-3 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring focus:border-red-300 changeStatusApproverControl">
