                    ...
                    @foreach ($groupList as $group)
                        <tr class="bg-white">
                            ...
                            <td class="px-6 py-4">
                                ...
                                @else
                                    <button type="submit" data-id="{{ $group->id }}"
                                            class="px-4 py-2 mr-3 bg-green-500 text-white rounded-md hover:bg-green-600 focus:outline-none focus:ring focus:border-green-300 changeStatusGroupControl">
                                        فعالسازی
                                    </button>
                                @endif
                            </td>
